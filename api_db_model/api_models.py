...
class ML_models:
    ...
    def create_model(self, model_name: str = '', **kwargs) -> Dict:
        ...
        if model_name in self.available_models[self.task_type]:
            ...
            self.counter -= 1
            print('''Wrong model name {}{}'''.format(model_name, self.available_models[self.task_type]))
    ...
    def update_model(self, model_dict: dict) -> None:
        ...
        try:
            ...
            raise 'Incorrect dictionary passed.'
        except TypeError:
            raise 'Dictionary should be passed.'
    ...
    def fit(self, model_id, data, **kwargs) -> Dict:
        ...
        self.update_data_in_db(model_dict, model=algo)
        return model_dict
    ...
    def predict_proba(self, model_id, X, to_dict: bool = True, **kwargs) -> Union[DataFrame, Any]:
        ...
        try:
            ...
            print(f'Models with task_type {self.task_type} has no method predict_proba')
    ...
    def get_scores(self, model_id, data, **kwargs) -> Dict:
        ...
        """
        if data is None:
            print('LOL! For compute metric needs data!')
        ...
        model = self.get_fitted_model(model_id)['model']
        self.update_data_in_db(model_dict, model=model)
        return model_dict
